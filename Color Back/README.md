# Color Back
## Context:
It's a training project to learn how to manipulate the 2D mechanics in Unity including the tilemap tool and how to use post processing through scripts. It was also the opportunity to start writing a game design document. You can find in this repository, [game design document](Color%20Back%20-%20Game%20Design%20Document%20by%20CyberTorii.pdf), scripts used and the all different assets drew (characters and maps components).
